                ...
                <div class="row x_title">
                    ...
                    <div class="col-md-6">
                        <div id="reportrange" class="pull-right" style="background: #fff; cursor: pointer; padding: 5px 10px; border: 1px solid #ccc">
                            ...
                            <span>June 2, 2019 - July 1, 2019</span> <b class="caret"></b>
                        </div>
                    </div>
                </div>
                <div class="col-md-9 col-sm-9 col-xs-12">
                    <div id="chart_plot_01" class="demo-placeholder" style="padding: 0px; position: relative;"><canvas class="flot-base" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 863px; height: 280px;" width="863" height="280"></canvas>
                        <div class="flot-text" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; font-size: smaller; color: rgb(84, 84, 84);">
                            <div class="flot-x-axis flot-x1-axis xAxis x1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;">
                                <div class="flot-tick-label tickLabel" style="position: absolute; max-width: 107px; top: 264px; left: 13px; text-align: center;">Jan 01</div>
                                <div class="flot-tick-label tickLabel" style="position: absolute; max-width: 107px; top: 264px; left: 150px; text-align: center;">Jan 02</div>
                                <div class="flot-tick-label tickLabel" style="position: absolute; max-width: 107px; top: 264px; left: 287px; text-align: center;">Jan 03</div>
                                <div class="flot-tick-label tickLabel" style="position: absolute; max-width: 107px; top: 264px; left: 424px; text-align: center;">Jan 04</div>
                                <div class="flot-tick-label tickLabel" style="position: absolute; max-width: 107px; top: 264px; left: 561px; text-align: center;">Jan 05</div>
                                <div class="flot-tick-label tickLabel" style="position: absolute; max-width: 107px; top: 264px; left: 698px; text-align: center;">Jan 06</div>
                            </div>
                            <div class="flot-y-axis flot-y1-axis yAxis y1Axis" style="position: absolute; top: 0px; left: 0px; bottom: 0px; right: 0px; display: block;">
                                ...
                                <div class="flot-tick-label tickLabel" style="position: absolute; top: 39px; left: 1px; text-align: right;">110</div>
                        ...
                        </div><canvas class="flot-overlay" width="863" height="280" style="direction: ltr; position: absolute; left: 0px; top: 0px; width: 863px; height: 280px;"></canvas></div>
                </div>
...
@endsection @section('outside-content')
...
<span id="pearlItButtonImg" unselectable="on" class="pearlItButton" style="position: absolute; display: none; cursor: pointer; z-index: 150000000; user-select: none; opacity: 0; width: 34px; height: 34px;"></span>
<span id="pearlItButtonTxt" unselectable="on" class="pearlItButton" style="position: absolute; display: none; cursor: pointer; z-index: 150000000; user-select: none; opacity: 0; width: 34px; height: 34px;"></span>
<form id="pearlIt" method="post" action="https://www.pearltrees.com/s/pearler/listFromAddons" target="pearltrees_overlay"><input type="hidden" name="url"><input type="hidden" name="title"><input type="hidden" name="layout"><input type="hidden" name="text"><input type="hidden" name="buttonParams"><input type="hidden" name="version" value="0.9"></form>
<div class="jqvmap-label" style="display: none; left: 748px; top: 1374px;"></div>
